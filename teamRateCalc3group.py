# Prints teamrating for a bunch of users grouped into groups of 3 using their max ratings
...
def batchto3(given_ratings):
    n = len(given_ratings) // 3
    for i in range(n):
        print(teamrate([given_ratings[i * 3], given_ratings[i * 3 + 1], given_ratings[i * 3 + 2]]))
